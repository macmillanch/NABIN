...
const VALID_JOB_TRANSITIONS = {
  ...
  'ACCEPTED': ['ASSIGNED', 'PENDING_RESTAURANT'],
  'PREPARING': ['ACCEPTED'],
  'READY_FOR_PICKUP': ['ACCEPTED', 'PREPARING'],
  'DRIVER_ARRIVING': ['ASSIGNED', 'ACCEPTED'],
  'DRIVER_ARRIVED': ['ASSIGNED', 'ACCEPTED', 'DRIVER_ARRIVING'],
  'IN_TRANSIT': ['ASSIGNED', 'ACCEPTED', 'DRIVER_ARRIVED', 'READY_FOR_PICKUP'],
  'OUT_FOR_DELIVERY': ['IN_TRANSIT'],
  'COMPLETED': ['IN_TRANSIT', 'OUT_FOR_DELIVERY', 'READY_FOR_PICKUP', 'ASSIGNED'],
  'CANCELLED': ['REQUESTED', 'SEARCHING', 'ASSIGNED', 'ACCEPTED', 'PREPARING', 'DRIVER_ARRIVING', 'DRIVER_ARRIVED', 'PENDING_RESTAURANT']
};
